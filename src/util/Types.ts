import {
  type SettingsOptionsStringArray,
  StringArraySettings,
  type SettingsOptionBoolean,
  BooleanSettings,
  type SettingsOptionNumber,
  NumberSettings,
  type SettingsOptionTopic,
  TopicSettings,
  type Topic,
} from "./Constants.js";

function isSettingStringArray(input: any): input is SettingsOptionsStringArray {
  return typeof input === "string" && StringArraySettings.includes(input);
}

function isSettingBoolean(input: any): input is SettingsOptionBoolean {
  return typeof input === "string" && BooleanSettings.includes(input);
}

function isSettingNumber(input: any): input is SettingsOptionNumber {
  return typeof input === "string" && NumberSettings.includes(input);
}
